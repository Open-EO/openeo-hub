	...
	<div :class="{collapsible: collapsible, backend: 1}">
        ...
        <dl>
            ...
            <dd v-show="backend.endpoints && !collapsed.functionalities">
                <SupportedFeatures :endpoints="preparedBackend.endpoints" :version="preparedBackend.version" ref="supportedFeaturesComponent"></SupportedFeatures>
            </dd>
            ...
            <dd v-if="backend.collections && !collapsed.collections">
                <CollectionWrapper v-for="collection in preparedBackend.collections" :key="collection.name" :collectionData="collection" :version="preparedBackend.version" :initiallyCollapsed="true"></CollectionWrapper>
            </dd>
            ...
            <dd v-if="preparedBackend.processes && !collapsed.processes">
                <ProcessWrapper v-for="process in backend.processes" :key="process.name || process.id" :processData="process" :version="preparedBackend.version" :initiallyCollapsed="true" :provideDownload="false"></ProcessWrapper>
            </dd>
            ...
            <dd v-if="backend.serviceTypes && !collapsed.serviceTypes">
                <SupportedServiceTypes :services="preparedBackend.serviceTypes" :version="preparedBackend.version"></SupportedServiceTypes>
            </dd>
            ...
            <dd v-if="backend.billing && !collapsed.billing" class="billing">
                <BillingPlans :billing="backend.billing" :version="preparedBackend.version"></BillingPlans>
            </dd>
        </dl>
